...
class App < Sinatra::Base
	...
	get '/test' do
		system("PGPASSWORD=iyajy1kgp2nczrpi pg_dump --cluster 10.12/main --clean -h gigatwitter-db-postgresql-do-user-7074878-0.db.ondigitalocean.com -p 25060 -U doadmin -Fc -t users nt_dev > ./lib/backup/user_dump_file.pgsql")
		...
		system ("PGPASSWORD=iyajy1kgp2nczrpi pg_restore --cluster 10.12/main -d 'postgresql://doadmin:iyajy1kgp2nczrpi@gigatwitter-db-postgresql-do-user-7074878-0.db.ondigitalocean.com:25060/nt_dev?sslmode=require' --jobs 4 ./lib/backup/user_dump_file.pgsql")
